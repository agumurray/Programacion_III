public class test {
  public static void main(String args[]) {
    ...
    System.out.println("Maxima cantidad de islas que se pueden visitar: " + D.maxIslas(islas));
    RutaMinima<String> ruta = D.caminoMasCorto(islas, "Maldivas", "Jamaica");
    ListaGenerica<String> lista = ruta.getRuta();
