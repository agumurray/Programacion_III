package Modulo1.Practica4B.Ej1_2;
...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println(arbolBinarioB.sumaMaximaVertical(arbolBinarioB, 0));
        System.out.println(arbolBinarioB.sumaMaximaHorizontal(arbolBinarioB));
    }
}